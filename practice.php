...
<body class="theme-classic">
  <nav class="top-nav">
    <div class="nav-left">
      <h1 class="nav-title">🌨️Practice Mode</h1>
    </div>
    <div class="nav-right">
      <span class="username-display">✨<span style="color: <?php echo $usernameColor; ?>; font-weight: bold;"><?php echo htmlspecialchars($username); ?></span>✨</span>
    ...
    <div class="game-left">
      ...
      <div class="card puzzle-card">
        <div class="game-stats">
          ...
          <div class="stat">
            <span class="stat-label">✔️Best:</span>
